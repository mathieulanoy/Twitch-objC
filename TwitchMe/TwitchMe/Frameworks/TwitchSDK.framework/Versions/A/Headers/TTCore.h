...
/*!
 * \brief   Returns a list of playlist objects for streaming
 * \param   name    channel name
 * \param   success block called on success
 * \param   failure block called on failure
 * \return  void
...
/*!
 * \brief   Returns a list of all emoticon objects for Twitch.
...
/*!
 * \brief   Returns all badges objects for Twitch.
 * \param   channel         channel
 * \param   success         block called on success
 * \param   failure         block called on failure
 * \return  void
